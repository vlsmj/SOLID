 ...
 *
 * The Subtraction class has one single responsibility, it is to return the difference between inputOne and inputTwo.
 */
class Subtraction : Arithmetic() {
     ...
     *
     * The Subtraction class is a subclass of Arithmetic class, which then overrides compute function without changing Arithmetic class' compute function itself.
     */
