 ...
 *
 * The Division class has one single responsibility, it is to return the quotient of inputOne and inputTwo.
 */
class Division : Arithmetic() {
     ...
     *
     * The Division class is a subclass of Arithmetic class, which then overrides compute function without changing Arithmetic class' compute function itself.
     */
